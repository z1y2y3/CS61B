...
public class Plip extends Creature {
    ...
    public Color color() {
        r = 99;
        b = 76;
        g = convertEnergyToG(energy);
        return color(r, g, b);
    }

    private int convertEnergyToG(double e) {
        // [0,2] --> [63,255]
        int value = (int) (63 + 96 * e);
        return value;
    }
    ...
    public Action chooseAction(Map<Direction, Occupant> neighbors) {
        ...
        List<Direction> directionsOfCloruses = getNeighborsOfType(neighbors, "clorus");
        if (!directionsOfCloruses.isEmpty()) {
